...
def select_score_one_image():
    ...
    tk.Label(window_test1, text='Left: neighboring semantics (400x400); Right: patches to be tested (128x128)', bg='Khaki').place(x=120, y=10)
